...
use Modules\Tax\Services\GlobalCalculation;
use Modules\Tax\Services\NewTaxPrice;
use Modules\Tax\Services\NewTaxPrices;
...
class TaxServiceProvider extends ServiceProvider
{
    ...
    public function registerActivityLogger()
    {
        ...
        $this->app->singleton('NewTaxPrice', function () {
            return new NewTaxPrice();
        });
        $this->app->singleton('NewTaxPrices', function () {
            return new NewTaxPrices();
        });
        $this->app->singleton('TaxCache', function () {
            return new TaxCache();
        });
        $this->app->singleton('GlobalCalculation', function () {
            return new GlobalCalculation();
        });
    }
