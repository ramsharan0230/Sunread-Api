...
return [
    ...
    'response' => [
        ...
        'invalid-adyen-notification-request' => 'Invalid Notification Request',
        'adyen-payment-incomplete' => 'Adyen Payment Is Incompleted',
        'payment-method-not-enabled' => ":name Not Enabled",
    ...
    'exception_message' => [
        ...
        "payment-klarna-checkout-incomplete" => "Unable to complete payment klarna checkout.",
        "destructive-method-forbidden" => "You cannot use destructive method.",
    ],
    "cart" => [
    ...
    "validation" => [
        ...
        "mimes" => "The :name must be a file of type: bmp, jpeg, jpg, png.",
        "max:25" => "The :name should not be greater than 255 characters.",
        "in" => "The :name is invalid",
        "decimal" => "The :name field should be a number",
        "integer" => "The :name field should be an integer",
        "array" => "The :name field should be an array",
        "date" => "The :name field should be date",
        "file" => "The :name field should be file",
        "boolean" => "The :name field should be bool",
        "string" => "The :name field should be a string",
        "exists" => "The :name does not exists.",
        "url" => "The :name is invalid.",
        "max"=> "Maximum Upload size of :name is 2MB."
    ],
    "erp" => [
        "create-success" => "Product migration processed successfully.",
        "update-success" => "Product update processed successfully.",
        "inventory-success" => "Product inventory update processed successfully.",
        "price-success" => "Product price update processed successfully.",
        "processed-success" => ":name processed successfully.",
        "initialized-success" => ":name initialized successfully.",
    ],
    "order_comment" => [
        "create-update-success" => ":name is created or updated.",
        "api-initialized" => ":name api initialized successfully.",
        "confirmation-api-exception" => ":name confirmation api exception occured.",
        "confirmation-api-response-received" => ":name confirmation api response received successfully.",
        "order-captured" => ":name order captured successfully.",
        "order-captured-denied" => ":name order capture denied.",
    ]
];
