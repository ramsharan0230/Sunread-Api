        ...
        "children" => [
            ...
            [
                ...
                "subChildren" => [
                    [
                        ...
                        "elements" => [
                            [
                                "title" => "New Order Email Template",
                                "path" => "new_order",
                                "type" => "select",
                                "provider" => "Modules\EmailTemplate\Entities\NewOrderTemplate",
                                "pluck" => [ "name", "id" ],
                                "default" => "9",
                                "options" => [],
                            ...
                            [
                                "title" => "Order Commented Email Template",
                                "path" => "order_comment",
                                "type" => "select",
                                "provider" => "Modules\EmailTemplate\Entities\OrderCommentTemplate",
                                "pluck" => [ "name", "id" ],
                                "default" => "10",
                                "options" => [],
                                "rules" => "exists:email_templates,id",
                            ...
                            [
                                ...
                                "type" => "select",
                                "provider" => "Modules\EmailTemplate\Entities\OrderStatusUpdateTemplate",
                                "pluck" => [ "name", "id" ],
                                "default" => "11",
                                "options" => [],
                                "rules" => "exists:email_templates,id",
            ...
            [
                ...
                "subChildren" => [
                    ...
                    config("deliveryflatrateone"),
                    config("deliveryflatratetwo"),
                    config("deliveryflatratethree"),
                    config("deliveryflatratefour"),
                    config("deliveryflatratefive"),
